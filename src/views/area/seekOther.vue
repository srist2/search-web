<template>
  <el-container>
    <div class="navigation">
      <span class="title">其他寻找</span>
      <span class="title-translate">SEEK OTHER</span>
      <el-image class="nav-img" :src="require('../../assets/seekOther.png')"/>
    </div>
    <div class="show-list">
      <div class="show-item" v-for="(item, index) in familySearchList.slice((pageNum-1)*pageSize,pageNum*pageSize)"
           :key="index">
  ...
  export default {
    ...
    methods: {
      ...
      jumpDetails(index) {
        ...
        this.$router.push({path: '/missMessageDetails', query: {infoId: infoId}});
      }
    },
    created() {
      this.init();
